...
// Test Package for the vmaas-cmp-go-sdk package.
...
func assertResponse(t *testing.T, resp *cmp.Response, err error) {
	assertError(t, err)
	if resp == nil {
...
func assertBadResponse(t *testing.T, resp *cmp.Response, err error) {
...
func assertResponseStatusCode(t *testing.T, resp *cmp.Response, statusCode int) {
...
func logFailure(t *testing.T, resp *cmp.Response, err error) {
	// logResponse(t, resp)
...
func logResponse(t *testing.T, resp *cmp.Response) {
